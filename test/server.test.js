...
describe("Server", function () {
    it("should return 'Hello Eldad API' when accessing the root", function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    (0, chai_1.expect)(response.text).to.equal("Hello Eldad API");
                    return [2 /*return*/];
            }
        });
    }); });
...
describe("Blog Endpoints", function () {
    describe("Blog Endpoints", function () {
        it("should create a new blog", function () { return __awaiter(void 0, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        (0, chai_1.expect)(response.status).to.equal(200);
                        (0, chai_1.expect)(response.body.blog_name).to.equal("Test Blog");
                        return [2 /*return*/];
                }
            });
        }); });
